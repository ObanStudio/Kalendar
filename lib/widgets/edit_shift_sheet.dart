...
class _EditShiftSheetState extends State<EditShiftSheet> {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  _typeBtn('night', Icons.mode_night_rounded, 'Ночь', accent),
                  _typeBtn('24h', Icons.change_circle_rounded, 'Сутки', accent),
                  _typeBtn('off', Icons.weekend_rounded, 'Выходной', Colors.orangeAccent),
                ],
              ),
            ),
            const SizedBox(height: 20),
  ...
  Widget _typeBtn(String type, IconData icon, String label, Color accentColor) {
    final selected = _type == type;
    final activeColor = type == 'off' ? Colors.orangeAccent : const Color(0xFF607D8B);
    return Expanded(
        ...
        child: AnimatedContainer(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 4),
              Text(label,
                style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: selected ? Colors.white : Colors.grey.shade500),
